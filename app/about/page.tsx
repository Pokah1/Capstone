...
const AboutPage = () => {
  ...
  return (
    <div style={{ backgroundColor: '#0f152b' }} 
    ...
    className="flex flex-col min-h-screen">
         <div className="flex flex-col items-start space-y-4">
              ...
              <Link
                href="/"
                className="inline-flex h-9 items-center justify-center rounded-md bg-white px-4 py-2 text-sm font-medium text-black shadow transition-colors hover:bg-blue-500 focus:outline-none focus:ring-2 focus:ring-blue-400 disabled:pointer-events-none disabled:opacity-50 mt-3"
              >
                Home
              </Link>
            </div>
...
<Image src={ProfileIcon} alt="profile dp" width={100} height={100} className="rounded-full"/>
    </div>
    <div className="text-center">
      <h3 className="text-lg font-bold text-gray-50">Odokwo Edikan</h3>
  ...
  <div className="flex flex-col items-center justify-center space-y-2">
    ...
    <div className="text-center">
      <h3 className="text-lg font-bold text-gray-50">Ezekwe Nelson</h3>
  ...
  <div className="flex flex-col items-center justify-center space-y-2">
    ...
    <div className="text-center">
      <h3 className="text-lg font-bold text-gray-50">Aniebiet Eyo</h3>
